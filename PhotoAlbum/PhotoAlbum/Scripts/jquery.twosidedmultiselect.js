(function($) {
	...
	$.fn.twosidedmultiselect = function() {
		...
		return this.each(function() {
			...
			"<p class=\"AddOne\" rel=\"" + newName + "\" title=\"Add Selected\"><i class='fa fa-angle-right'></i></p>" +
			"<p class=\"AddAll\" rel=\"" + newName + "\" title=\"Add All\"><i class='fa fa-angle-double-right'></i></p>" +
			"<p class=\"RemoveOne\" rel=\"" + newName + "\" title=\"Remove Selected\"><i class='fa fa-angle-left'></i></p>" +
			"<p class=\"RemoveAll\" rel=\"" + newName + "\" title=\"Remove All\"><i class='fa fa-angle-double-left'></i></p>" +
			"</div>" +
